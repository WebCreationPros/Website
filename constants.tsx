...
export const TiktokIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" {...props}>
    <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-2.43.03-4.83-.97-6.46-2.98-1.6-1.98-2.09-4.82-1.58-7.18.52-2.41 2.51-4.45 4.88-5.32 2.37-.86 4.8-.8 7.03-.05.02-1.5-.04-2.99-.01-4.49-.13-1.04-.48-2.04-.9-2.99C12.82.97 12.62.48 12.525.02zM12.01 18.23c-1.38 0-2.73-.2-4.01-.7-.79-.3-1.51-.76-2.1-1.36-.59-.6-.97-1.37-1.1-2.23-.13-.85-.02-1.78.37-2.58.39-.8 1.05-1.44 1.88-1.84 1.71-.81 3.6-.86 5.3-.12V18.23z"/>
  </svg>
);

export const ThreadsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12 4.72a7.28 7.28 0 1 0 7.28 7.28A7.29 7.29 0 0 0 12 4.72Zm0 12.91a5.63 5.63 0 1 1 5.63-5.63 5.64 5.64 0 0 1-5.63 5.63Z"/>
    <path d="M11.13 14.58H9.84V9.42h1.29c1.39 0 2.25.8 2.25 2.58s-.86 2.58-2.25 2.58Zm-1.29-1.12h1.29c.68 0 1.13-.52 1.13-1.46s-.45-1.46-1.13-1.46H9.84v2.92Z"/>
  </svg>
);
